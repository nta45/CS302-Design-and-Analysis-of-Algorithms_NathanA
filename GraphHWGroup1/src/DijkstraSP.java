 ...
 * edge weights are integers and if none of the intermediate results exceeds
 * 2<sup>52</sup>. Since all intermediate results are sums of edge weights, they
 * are bounded by <em>V C</em>, where <em>V</em> is the number of vertices and
 * <em>C</em> is the maximum weight of any edge.
 * <p>
